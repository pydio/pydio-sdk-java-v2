...
import io.swagger.client.model.RestBindResponse;
import io.swagger.client.model.RestDeleteResponse;
import io.swagger.client.model.RestSearchUserRequest;
import io.swagger.client.model.RestUsersCollection;
...
public class UserServiceApi {
    ...
    public com.squareup.okhttp.Call bindUsersCall(String login, IdmUser body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/user/{Login}/bind"
    ...
    /**
     * Bind a user with her login and password (asynchronously)
     * 
     * @param login  (required)
     * @param body  (required)
