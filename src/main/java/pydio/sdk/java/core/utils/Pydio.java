...
public class Pydio {
    ...
    public final static String
            STR_ERROR_OK = "ok",
            STR_ERROR_NOT_A_SERVER = "not_pydio",
            STR_ERROR_WRONG_PATH = "wrong_path",
            STR_ERROR_CON_FAILED = "con_failed",
            STR_ERROR_CON_FAILED_SSL = "ssl_con_failed",
            STR_ERROR_UNVERIFIED_CERTIFICATE = "unverified_certificate",
            STR_ERROR_AUTHENTICATION = "auth",
            STR_ERROR_AUTHENTICATION_WITH_CAPTCHA = "auth_captcha",
            STR_ERROR_UNREACHABLE_HOST = "unreachable",
            STR_ERROR_ACCESS_REFUSED = "access_refused";
